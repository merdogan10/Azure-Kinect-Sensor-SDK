...
constexpr float DefaultZoom = 15.0f; // original: 65.0f, zoomed_in: 1.0f
...
//
const vec3 DefaultPointCloudPosition{ 0.f, -0.9f, -8.0f }; // original: { 0.f, 0.f, -8.0f }, zoomed_in: { -0.2f, -0.9f, -8.0f }
