...
void K4ASourceSelectionDockControl::OpenRecording(const std17::filesystem::path &path)
{
    try
    {
        ...
        string input_video_path2 = captures_folder + "v1\\charuco_rotate\\cn06\\k4a_record.mkv";
        ...
        for (int i = 0; i < 4; i++)
        {
            string projection_stats_path = captures_folder + type_str + '-' + mode_str[i] + '-' + "stats.txt";
