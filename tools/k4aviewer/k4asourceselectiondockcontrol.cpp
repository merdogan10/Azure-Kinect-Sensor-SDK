...
void K4ASourceSelectionDockControl::OpenRecording(const std17::filesystem::path &path)
{
    try
    {
        ...
        string icp_file =
            "C:\\Users\\Mustafa\\Desktop\\thesis\\captures\\icp\\cn03\\icp.txt";
        string icp_file2 =
            "C:\\Users\\Mustafa\\Desktop\\thesis\\captures\\icp\\cn06\\icp.txt";
        ...
        int case_no = 3; // Best cases for Charuco: 1, Quaternion: 3, ICP: 3
