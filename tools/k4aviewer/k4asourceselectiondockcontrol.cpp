...
void K4ASourceSelectionDockControl::OpenRecording(const std17::filesystem::path &path)
{
    ...
    {
        path;
        string world2camera_file =
            "C:\\Users\\Mustafa\\Desktop\\thesis\\captures\\vicon_calibration\\cn03\\world2camera.txt";
        string world2camera_file2 =
            "C:\\Users\\Mustafa\\Desktop\\thesis\\captures\\vicon_calibration\\cn06\\world2camera.txt";
        
        string input_video_path = "C:\\Users\\Mustafa\\Desktop\\thesis\\captures\\charuco_rotate\\cn03\\k4a_record.mkv";
        k4a::playback recording = k4a::playback::open(input_video_path.c_str());

        string input_video_path2 =
            "C:\\Users\\Mustafa\\Desktop\\thesis\\captures\\charuco_rotate\\cn06\\k4a_record.mkv";
        ...
        int case_no = 3; // Best cases for Charuco: 1, Quaternion: 3

        Calibration calib(input_video_path, world2camera_file, calibration_type);
        Calibration calib2(input_video_path2, world2camera_file2, calibration_type);
